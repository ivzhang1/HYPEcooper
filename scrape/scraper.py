...
pageurls = ["https://stockx.com/adidas-yeezy-boost-350-v2-core-black-red-2017", "https://stockx.com/adidas-yeezy-boost-350-v2-steeple-grey-beluga-solar-red", "https://stockx.com/api/products/ef63b9c9-6102-4d4b-bce5-1b1a8b4cbce1/activity?state=480&currency=USD"]
...
for i in range(len(pagetargets)):
    print(pagetargets[i])
    driver.get(pagetargets[i])
